...
<link rel="stylesheet" href="/css/commentsbar.css"/>
  ...
  <div id="computer">
    <div id="maincontent"><br>
      <div id="form-wrap"><img src="https://jsd.15xd.cn/gh/Akilarlxh/Valine-Admin@v1.0/source/img/before.png" id="beforeimg">
        <div id="envelope">
          <form>
            <div class="formmain">
        ...
        </div><img id="afterimg" src="https://jsd.15xd.cn/gh/Akilarlxh/Valine-Admin@v1.0/source/img/after.png">
      </div>
    </div>
  </div>
  <div id="mobile">
